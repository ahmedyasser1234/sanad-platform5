...
const AboutSanad: React.FC<AboutSanadProps> = ({ lang }) => {
  const content = {
    ar: {
      title: 'تعرف على سند',
      description: 'تحرص الجامعة على تقديم تجربة تعليمية متكاملة لطلبتها، ومن هنا يأتي "تطبيق سند" كمنصة تفاعلية رقمية حديثة تواكب هوية الجامعة وتجمع في مكان واحد جميع ما يحتاجه الطالب في حياته الجامعية.',
      justificationsTitle: 'المبررات',
      objectivesTitle: 'الأهداف',
      justifications: [
        'غياب وجود دليل طالبي محدث ومتكامل.',
        'تشتت المعلومات بين عدة مصادر وإدارات.',
        'الحاجة لتجربة طالبية رقمية تفاعلية.',
        'تعزيز سهولة الوصول للمعلومات والخدمات.',
        'إبراز هوية الجامعة الحديثة.'
      ],
      objectives: [
        'إنشاء منصة موحدة للطالب تسهّل الوصول للخدمات.',
        'تعزيز تجربة الطالب أكاديمياً واجتماعياً.',
        'تحسين قنوات التواصل بين الطالب والإدارات.',
        'تقديم تجربة رقمية محدثة ومرنة للتطوير.',
        'دعم توجه الجامعة في التميز والابتكار.'
      ]
    },
    en: {
      title: 'About Sanad',
      description: 'The university strives to provide an integrated educational experience. "Sanad App" serves as a modern interactive digital platform that aligns with the university identity and consolidates everything a student needs in their university life.',
      ...
      justifications: [
        ...
        'Need for an interactive digital student experience.',
        'Enhancing ease of access to information.',
        'Highlighting the modern university identity.'
      ],
      objectives: [
        'Creating a unified platform for easy access.',
        'Enhancing student experience academically and socially.',
        'Improving communication channels.',
        'Providing a modern, flexible digital experience.',
        'Supporting the university\'s drive for innovation.'
      ]
    }
  };
    ...
    <section className="py-20 bg-transparent relative overflow-visible">
      ...
      <div className="container mx-auto px-6 relative z-10 pt-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-10 pt-4">
          ...
          {/* Justifications Card (Purple Theme) */}
          <div className="relative mt-12 bg-gradient-to-br from-purple-50 to-white border border-purple-100 px-6 pb-8 pt-20 rounded-[2.5rem] shadow-sm hover:shadow-md transition-shadow">
            ...
            {/* Sanad Character Icon (Animated: Bounce) - Moved to Left [310px] */}
            {/* Update: Moved further left on mobile (left-[35%]) and kept at left-[310px] on desktop */}
            {/* Update 2: For English on Mobile, move slightly more left (left-[25%]) */}
            {/* Update 3: For English on Mobile, move slightly right (left-[30%]) */}
          ...
          <div className="relative mt-12 bg-gradient-to-br from-sky-50 to-white border border-sky-100 px-6 pb-8 pt-20 rounded-[2.5rem] shadow-sm hover:shadow-md transition-shadow">
             ...
             {/* Sanad Character Icon (Animated: Pulse/Float) - Floating on Top */}
