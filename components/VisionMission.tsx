...
// --- CONFIGURATION ---
// Updated paths to absolute paths for Netlify compatibility
...
const VisionMission: React.FC<VisionMissionProps> = ({ lang }) => {
  ...
  return (
    <section className={`py-16 pb-32 relative transition-all duration-500 ${lang === 'en' ? 'bg-gradient-to-l' : 'bg-gradient-to-r'} from-[#bce6f9] via-[#e6f5fc] to-white`}>
      <div className="container mx-auto px-4 flex flex-col md:flex-row justify-center gap-10 md:gap-20 items-stretch">
        ...
        <div className="relative w-full max-w-md group">
            ...
            <div className="bg-gradient-to-br from-white/95 via-[#fff1f2]/70 to-[#ffe4e6]/40 backdrop-blur-2xl border border-white/70 rounded-[2.5rem] p-8 pt-16 shadow-[0_8px_32px_rgba(255,200,220,0.15)] text-center h-full flex flex-col items-center hover:shadow-[0_20px_50px_-15px_rgba(255,200,220,0.25)] transition-shadow duration-300">
